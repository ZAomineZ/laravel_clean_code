<x-guest-layout>
    <section class="h-screen w-screen flex items-center">
        <div class="max-w-2/3 mx-auto py-6 sm:px-6 lg:px-8">
            <div>
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px-0">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Post</h3>
                            <p class="mt-1 text-sm text-gray-600">Create a post</p>
                        </div>
                    </div>
                            ...
                            <div class="shadow sm:overflow-hidden sm:rounded-md">
                                <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-2 text-sm text-gray-500">This is your post body, make it interesting.</p>
                                    </div>
                                </div>
